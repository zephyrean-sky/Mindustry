...
public class LiquidTurret extends Turret{
    ...
    protected void effects(Tile tile){
        ...
        type.shootEffect.at(entity.liquids.current().color, tile.drawx() + tr.x, tile.drawy() + tr.y, entity.rotation);
        type.smokeEffect.at(entity.liquids.current().color, tile.drawx() + tr.x, tile.drawy() + tr.y, entity.rotation);
        //shootSound.at(tile);
